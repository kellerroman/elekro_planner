def define_testcase():
    yaml = dict()
    yaml["struktur"] = {'geschosse': [\
            {'id': 1, 'name': 'G1', 'height': 200, 'walls': [\
              {'id': 1, 'pos': {'hori': [0, 0]}, 'ende': [20, 300]}\
            , {'id': 2, 'pos': {'hori': [0, 0]}, 'ende': [500, 20]}\
            ]} \
          , {'id': 2, 'name': 'G2', 'height': 300, 'walls': [\
              {'id': 1, 'pos': {'hori': [0, 0]}, 'ende': [20, 300]}\
    ...
    yaml["kabel"] = {'kabel': [ \
                    {'id': 1, 'name': 'SK1 R22', 'start': '1.1.1', 'end': ['2.2.3', '2.2.4','2.2.5']}\
                 ]}
    return yaml
...
def define_testcase_simple1():
    ...
    yaml["anschluesse"]= {'geschosse': [\
     {'id': 1, 'name': 'G1', 'rooms': [\
      {'id': 1, 'name': 'R11', 'objects': [\
       {'id': 1, 'name': 'O111', 'con-type': 'steckdose', 'anzahl': 1, 'pos': {'hori': [50, 20], 'vert': 'unten'}}\
      ,{'id': 2, 'name': 'O112', 'con-type': 'steckdose', 'anzahl': 2, 'pos': {'hori': [20, 250], 'vert': 'unten'}}\
     ]}\
    ]}\
    ]}
    yaml["kabel"] = {'kabel': [ \
